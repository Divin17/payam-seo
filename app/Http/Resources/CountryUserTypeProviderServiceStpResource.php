...
class CountryUserTypeProviderServiceStpResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "service" => new CountryUserTypeProviderServiceResource(CountryUserTypeProviderService::whereId($this->service_id)->first()),
            "slug" => $this->slug,
