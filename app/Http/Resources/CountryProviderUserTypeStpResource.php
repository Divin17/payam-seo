...
class CountryProviderUserTypeStpResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "usertype" => new CountryProviderUserTypeResource(CountryProviderUserType::whereId($this->usertype_id)->first()),
            "slug" => $this->slug,
