...
class CountryProviderUserTypeServiceStpResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "service" => new CountryProviderUserTypeServiceResource(CountryProviderUserTypeService::whereId($this->service_id)->first()),
            "slug" => $this->slug,
