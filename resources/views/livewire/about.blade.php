<div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 text-center">
                    ...
                    <p class="lead">Whether you’re a programmer, designer, freelancer or need Impact for a
                        whole team our pricing just makes sense.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 mb-lg-6">
                <div class="col-12 col-md-8 text-center">
                    ...
                    <p class="lead">Even if you have the most loyal customers ever, they’ll still want to know
                        how things are going and for new users how to start.</p>
                </div>
            </div>
            <div class="row">
                <div class="timeline timeline-six px-3 px-lg-0">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                            ...
                            <span
                                class="d-none d-lg-block m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-primary">1</span>
                            <div class="row h-50">
                        ...
                        <div class="col-lg py-2">
                            <div class="card timeline-card bg-soft shadow-soft border-light p-3">
                                <div class="card-body p-4">
                                    <h4 class="mb-3"><span class="d-lg-none">1.</span> Create an account
                                    </h4>
                                    <p class="my-2">Once you're approved, you can then explore our platform
                                        functionalities and make your first test payment.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg py-2">
                            <div class="card left-timeline-card bg-soft shadow-soft border-light p-3">
                                <div class="card-body p-4">
                                    ...
                                    <p class="my-2">To start processing payments you’ll need to speak to our
                                        team for tailored advice and get an assessment of your business.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                            ...
                            <span
                                class="m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-primary">3</span>
                            <div class="row h-50">
                                <div class="col middle-line">&nbsp;</div>
                                <div class="col">&nbsp;</div>
                            </div>
                        ...
                        <div class="col-lg py-2">
                            <div class="card timeline-card bg-soft shadow-soft border-light p-3">
                                <div class="card-body p-4">
                                    ...
                                    <p class="my-2">You can now send your request to start processing
                                        payments with us. We’ll review the information, just to make sure we can help
                                        your business in the best way.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg py-2">
                            <div class="card left-timeline-card bg-soft shadow-soft border-light p-3">
                                <div class="card-body p-4">
                                    ...
                                    <p class="my-2">Find out more about Redbooth’s APIs and discover the
                                        infinite opportunities of this Platform.</p>
                                    <p>We recommend you to start using the interactive console of the Developer Portal
                                        and getting familiar with the different endpoints of the API with the
                                        documentation. Here’s an interesting read to start consuming the API using curl:
                                        9 uses for cURL worth knowing.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 text-center flex-column d-none d-lg-flex">
                            ...
                            <span
                                class="m-4 h4 lh-200 dot-separator bg-soft shadow-soft border border-light text-primary">4</span>
                            <div class="row h-50">
                                <div class="col">&nbsp;</div>
                                <div class="col">&nbsp;</div>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 mb-lg-7">
                <div class="col-12 text-center">
                    <h1 class="h1 font-weight-bolder mb-4 px-lg-8">Recommended by leading experts in marketing and SEO
                    </h1>
                ...
                <div class="col-12 col-lg-6">
                    <div class="customer-testimonial d-flex mb-5">
                        ...
                        <div class="content bg-soft shadow-soft border border-light rounded position-relative p-4">
                            ...
                            <p class="mt-2">"We use Impact mainly for its site explorer, and it’s immensely
                                improved how we find link targets. We use it both for getting quick analysis of a site,
                                as well as utilizing its extensive index when we want to dive deep."</p>
            ...
            <div class="row">
                <div class="col text-center">
                    <a href="./testimonials.html" class="btn btn-primary"><span class="mr-2"><i
    ...
    <section class="section section-lg pb-5 bg-primary text-white">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 text-center">
                    <!-- Button Modal -->
                    <a href="../../dashboard/pages/dashboards/dashboard.html"
                        class="btn btn-secondary animate-up-2"><span class="mr-2"><i
                                class="fas fa-hand-pointer"></i></span>Start 30-days trial</a>
                </div>
            </div>
        </div>
    </section>
