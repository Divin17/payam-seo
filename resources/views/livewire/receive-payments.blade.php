<div>
    <div
        ...
        <div class="loader-element">
            ...
            <img src="{{ URL::asset('assets/img/brand/dark-loader.svg') }}" height="60"
                alt="{{ config('app.name') }}" />
        </div>
    </div>
    <!-- Hero -->
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-7">
                    ...
                    <a href="/" class="btn rounded-pill p-0 animate-up-2 w-40">
                        <img class="img" src="{{ URL::asset('assets/img/playstore.png') }}" alt="" />
                    </a>
                    <a href="/" class="btn rounded-pill p-0 animate-up-2 w-40">
                        <img class="img" src="{{ URL::asset('assets/img/appstore.png') }}" alt="" />
                    </a>
                </div>
            </div>
        </div>
    ...
    <section class="section section-lg">
        <div class="container">
            <div class="row mb-2 mb-md-3">
                ...
                <div class="col-md-6">
                    <img src="{{ URL::asset('assets/img/illustrations/feature-illustration.svg') }}" alt="" />
                </div>
            </div>
                        ...
                        <ul class="nav nav-pills nav-fill flex-row" id="tabs-icons-text" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab"
                                    ...
                                    aria-selected="true">
                                    <h3 class="d-none d-md-block">{{ __('scan_to_pay') }}</h3>
                                    <h3 class="d-block d-md-none">Scan</h3>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab"
                                    ...
                                    aria-selected="false">
                                    <h3 class="d-none d-md-block">{{ __('pay_with_code') }}</h3>
                                    <h3 class="d-block d-md-none">{{ __('use_code') }}</h3>
                                </a>
                            </li>
                        </ul>
                    </div>
