            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-7">
                    ...
                    <h1 class="display-2 mb-3 font-weight-light text-white">
                        {{ json_decode($caption)->$locale ?? $defaultCountryHeader }}
                    </h1>
                                        ...
                                        <div class="d-flex flex-column flex-lg-row p-3">
                                            <div class="mb-3 mb-lg-0">
                                                <div class="icon icon-primary">
                                                    <img src="{{ URL::asset($service->icon) }}"
                                                        alt="{{ json_decode($service->name)->$locale }}"
                                                        width="40px" />
                                                </div>
                                            </div>
                                            <div class="pl-lg-4">
                                                <a
                                                    href="{{ route('show_service', ['country' => $country->slug, 'slug1' => $usertype->slug, 'slug2' => $provider->slug, 'service' => $service->slug, 'locale' => $locale]) }}">
                                                    <h4 class="mb-3">
                                                ...
                                                <a href="{{ route('show_service', ['country' => $country->slug, 'slug1' => $usertype->slug, 'slug2' => $provider->slug, 'service' => $service->slug, 'locale' => $locale]) }}"
