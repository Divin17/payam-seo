...
class CreateCountryProviderUserTypeServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('country_provider_user_type_services', function (Blueprint $table) {
            $table->id();
            $table->text('slug');
    ...
    {
        Schema::dropIfExists('country_provider_usertype_services');
    }
}
